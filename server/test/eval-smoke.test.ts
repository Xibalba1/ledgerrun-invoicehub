...
import { EntityResolutionProposal, ExtractedInvoice, MatchProposal } from "@ledgerrun/contract";
...
// validation chain (entity proposal → scoped catalog → decide) and assert the
// golden decision per sample. No network — safe for the Stop gate. The live LLM
// eval (eval/run.ts) is the on-demand counterpart that proves extraction,
// entity resolution, and matching for real.
